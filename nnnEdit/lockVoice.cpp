...
CLockVoice::CLockVoice(CMyApplicationBase* app)
{
	m_app = app;
...
CLockVoice::~CLockVoice()
{
	End();
}

void CLockVoice::End(void)
{
}

BOOL CLockVoice::AllLockVoice(BOOL flg)
{
...
BOOL CLockVoice::LockVoice(BOOL flg)
{
//	CFilmCaseDoc* pDoc = (CFilmCaseDoc*)m_document[FILMCASE_WINDOW];
//	CFilmCaseData* pCase = pDoc->GetFilmCaseData();
	CFilmCaseData* pCase = m_app->GetFilmCaseData();
